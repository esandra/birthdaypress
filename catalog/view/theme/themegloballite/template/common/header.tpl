...
?>
    ...
    <?php $listcssjs = array(
  		...
  		'catalog/view/theme/'.$config->get( 'config_template' ).'/js/jquery.elevateZoom-3.0.3.min.js',
			...
			'catalog/view/theme/'.$config->get( 'config_template' ).'/js/modernizr.custom.js',
			'catalog/view/theme/'.$config->get( 'config_template' ).'/js/classie.js',
			...
			'catalog/view/theme/'.$config->get( 'config_template' ).'/js/mlpushmenu.js'
    ); ?>
					...
					<div class="row">
						...
						<div class="container">
							<div class="logo-store" >
								...
								<a id="fp-cart" href="<?php echo $shopping_cart; ?>">
										...
										<!-- <div id="tg-search2">
											...
											<ul class="dropdown-menu keep_open">
												<li> -->
													...
													<div id="search">
														<input type="text" name="search2" placeholder="<?php if($theme_options->get( 'search_text', $config->get( 'config_language_id' ) ) != '') { echo html_entity_decode($theme_options->get( 'search_text', $config->get( 'config_language_id' ) )); } else { echo 'Search for Items or Brands'; } ?>" value="" />
														<a class="button-search2 bmg-l-header__search-btn">
															<span class="fa fa-search"></span>
														</a>
													</div>	
												<!-- </li>
