		...
		<div class="mini-cart-info">
			<table>
				...
				<tr>
					...
					<td class="remove"><a href="javascript:;" onclick="cart.remove('<?php echo $product['key']; ?>');" title="<?php echo $button_remove; ?>"><img src="catalog/view/theme/<?php echo $config->get('config_template');?>/image/tg-remove.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>"/></a></td>
				</tr>
				<?php } ?>
